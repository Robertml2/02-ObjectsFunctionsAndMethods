...
def turtle4():
    ...
    linda = rg.SimpleTurtle()
    linda.speed = 20
    linda.pen = rg.Pen('cyan',30)
...
def turtle5():
    ...
    mindy = rg.SimpleTurtle()
    katy = rg.SimpleTurtle()
    mindy.speed = 40
    katy.speed = 16
    mindy.pen = rg.Pen('slate blue',22)
    katy.pen = rg.Pen('peach puff',40)

    katy.draw_circle(100)
    katy.forward(35)
    katy.right(90)
    katy.forward(30)
